...
function slider(_ref) {
  ...
  function getZeroSlides(arr, str, count) {
    if (arr < 10) {
      str.textContent = "0".concat(count);
    } else {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Cloud not fetch: ".concat(res, ", status: ").concat(res.status));
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__.showModal)('.modal', modalTimerId);
  }, 300000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_8__["default"])('.timer', '2022-05-11');
});
})();
